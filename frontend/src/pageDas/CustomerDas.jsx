...
const Customer = () => {
  ...
  return (
    <div>
      ...
      <Modal
        title={
          formCate.getFieldValue("Id") == null ? "New customer" : "Update customer"}
          open={open}
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please fill in customer firstname",
                  },
                ]}
              >
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please fill in customer Lastname",
                  },
                ]}
              >
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please fill in customer Gender",
                  },
                ]}
              >
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please fill in customer Dob",
                  },
                ]}
              >
                <DatePicker
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please fill in customer Tel",
                  },
                ]}
              >
