...
const OrderStatusDas = () => {
  ...
  const getList = async () => {
    ...
    const res = await request("payment_method/getlist", "get",param);
    if (res) {
      setList(res.list);
    }
    console.log(res);
  ...
  const onClickDelete = async (item) => {
    Modal.confirm({
      ...
      onOk: async () => {
        ...
        const res = await request("payment_method/delete", "delete", data);
        if (res) {
  ...
  const onFinish = async (item) => {
    ...
    var url = (Id == null ? "payment_method/create" : "payment_method/update")
        ...
        >
          <Form.Item 
            ...
            rules={[
              {
                required : true,
                message : "Please fill in order_status name"
              }
            ]}
          >
            <Input placeholder="order status name" />
          </Form.Item>
